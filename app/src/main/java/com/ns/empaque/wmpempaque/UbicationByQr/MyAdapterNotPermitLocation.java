 ...
 */
public class MyAdapterNotPermitLocation extends ArrayAdapter {

    public Activity nContext;
    private String[] folios;
    private JSONArray notPermits;

    public MyAdapterNotPermitLocation(Activity nContext, String[] folios, JSONArray notPermits) {
        super(nContext, R.layout.viewadapternopermitfolioslocation,folios);
        this.folios = folios;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        convertView = layoutInflater.inflate(R.layout.viewadapternopermitfolioslocation, null);
